...
Namespace Sublight.WS
    ...
    Public Class SearchSubtitles3CompletedEventArgs
        ...
        Public ReadOnly Property isLimited As Boolean
            Get
                RaiseExceptionIfNecessary()
                Return DirectCast(results(3), bool)
            End Get
        End Property
    ...
    End Class ' class SearchSubtitles3CompletedEventArgs
