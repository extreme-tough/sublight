...
Namespace Sublight.WS_SublightClient
    ...
    Public Class CheckForUpdatesCompletedEventArgs
        ...
        Public ReadOnly Property newVersion As Sublight.WS_SublightClient.VersionInfo
            Get
                RaiseExceptionIfNecessary()
    ...
    End Class ' class CheckForUpdatesCompletedEventArgs
